...
/** L'ingombro reale di un tile: 144, non il 180 su cui è disegnato. Arriva dal
 ...
 * 144 + 8+8 + 6 + 1 = 167. Sotto questa soglia il tile verrebbe tagliato, quindi
...
export function StagingPanel({
   ...
   * padding lascia il rettangolo intatto a 180×100.
   */
